...
TF: En esta entrega cada integrante realizará una conclusión propia:
* A lo largo del proyecto se ahondaron en conocimientos de fullstack, ampliando nuestro conocimiento sobre programación, además, nuestro proyecto que esta centrado en empresas de belleza nos permitió conocr más sobre las necesidades de este sector, priorizando el estilo y el trato con el cliente por sobre todo.
<br>
