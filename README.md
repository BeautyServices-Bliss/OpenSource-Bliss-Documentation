...
|US022|Creacion de servicio| Como empresa, quiero crear un servicio a traves de la aplicacion para que los usuarios de la aplicación lo visualizen.|
|US023|Eliminación de servicio| Como empresa, quiero poder eliminar un servicio que yo cree para mantener los servicio relevantes y a mi criterio.|
| US024  | Gestión de servicios ofrecidos     | Como empresa, quiero gestionar los servicios que ofrezco en la aplicación, incluyendo la actualización de disponibilidad.     | Escenario 1: Actualización de Servicios: Cuando modifica la lista de servicios ofrecidos, los cambios se reflejan en la aplicación.<br>Escenario 2: Disponibilidad de Servicios: Cuando actualiza la disponibilidad de los servicios, el sistema muestra los horarios y opciones actualizados.  | EP005|
| US025  | Gestión de espeficiaciones de los servicios| Como empresa, quiero poder gestionar las especificaciones de los servicios que ofrezco en la aplicación, incluyendo las opciones de personalización     | Escenario 1: Actualización de Servicios: Cuando modifica la lista de servicios ofrecidos, los cambios se reflejan en la aplicación.<br>Escenario 2: Disponibilidad de Servicios: Cuando actualiza la disponibilidad de los servicios, el sistema muestra los horarios y opciones actualizados.  | EP005|
